# Example 061: Numerical Derivative
...
Use numerical derivative when modeling mathematical change, relationships between variables, or numerical optimization.

## Simple real-world scenario

Start with a small x/y relationship, calculate numerical derivative manually, then use the Python function to show how the same mathematics scales to many values.
