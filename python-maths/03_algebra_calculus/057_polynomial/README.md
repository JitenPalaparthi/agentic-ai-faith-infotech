# Example 057: Polynomial Evaluation
...
Use polynomial evaluation when modeling mathematical change, relationships between variables, or numerical optimization.

## Simple real-world scenario

Start with a small x/y relationship, calculate polynomial evaluation manually, then use the Python function to show how the same mathematics scales to many values.
