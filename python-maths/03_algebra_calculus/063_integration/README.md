# Example 063: Numerical Integration
...
Use numerical integration when modeling mathematical change, relationships between variables, or numerical optimization.

## Simple real-world scenario

Start with a small x/y relationship, calculate numerical integration manually, then use the Python function to show how the same mathematics scales to many values.
