# Example 053: Linear Equation y = mx + c
...
Use y = mx + c when one quantity changes approximately at a constant rate with another.

## Simple real-world scenario

A taxi fare might have a ₹50 base charge plus ₹15 per kilometre: fare = 15×distance + 50. Here 15 is the slope and 50 the intercept.
...
A straight-line model is inappropriate when the relationship has strong curvature or changing rates.
