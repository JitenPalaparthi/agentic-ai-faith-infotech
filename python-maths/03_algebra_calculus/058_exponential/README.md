# Example 058: Exponential Function
...
Use exponential function when modeling mathematical change, relationships between variables, or numerical optimization.

## Simple real-world scenario

Start with a small x/y relationship, calculate exponential function manually, then use the Python function to show how the same mathematics scales to many values.
