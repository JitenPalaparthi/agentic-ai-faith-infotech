...
Use deriving y = mx + c when modeling mathematical change, relationships between variables, or numerical optimization.

## Simple real-world scenario

Start with a small x/y relationship, calculate deriving y = mx + c manually, then use the Python function to show how the same mathematics scales to many values.
