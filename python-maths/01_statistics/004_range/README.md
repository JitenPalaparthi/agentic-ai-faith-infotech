...
Use range when summarizing or interpreting numerical data and this mathematical property matches the question you are asking.

## Simple real-world scenario

During exploratory analysis, calculate range on a small business dataset, verify the result manually, and then apply it to the complete dataset.
