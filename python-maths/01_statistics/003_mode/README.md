...
Use the mode when you need the most common category or repeated value.

## Simple real-world scenario

An e-commerce company checks the most frequently purchased T-shirt size. If M occurs most often, M is the mode and can guide stocking.
...
A dataset may have more than one mode, or no uniquely useful mode.
