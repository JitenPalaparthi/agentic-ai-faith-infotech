...
Use R² to describe how much variation a regression model explains relative to predicting the target mean on the evaluated data.

## Simple real-world scenario

An R² of 0.80 means the model accounts for 80% of the target variation under this definition and evaluation dataset.
...
A high R² does not prove causality or good out-of-sample prediction; inspect residuals and validation performance too.
