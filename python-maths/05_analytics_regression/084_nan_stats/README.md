# Example 084: Missing Values and NaN
...
**nanmean ignores NaN observations**
...
Use missing values and nan when building an analytical or regression workflow where this concept answers a specific modeling or evaluation question.

## Simple real-world scenario

Apply missing values and nan to a small sales, latency, pricing, or sensor dataset and compare the mathematical result with the Python output.
