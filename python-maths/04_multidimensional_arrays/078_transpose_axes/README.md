# Example 078: Reordering Tensor Axes
...
**(a,b,c) → permutation such as (c,a,b)**
...
Use reordering tensor axes when data has multiple axes such as observations, features, time, batches, images, or channels.

## Simple real-world scenario

Think of a batch of images or a table of observations and features; reordering tensor axes helps organize or calculate across the required dimensions efficiently.
