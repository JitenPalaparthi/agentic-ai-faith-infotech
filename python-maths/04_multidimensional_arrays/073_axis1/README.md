...
**mean(X,axis=1) → one value per row**
...
Use axis 1 reduction when data has multiple axes such as observations, features, time, batches, images, or channels.

## Simple real-world scenario

Think of a batch of images or a table of observations and features; axis 1 reduction helps organize or calculate across the required dimensions efficiently.
