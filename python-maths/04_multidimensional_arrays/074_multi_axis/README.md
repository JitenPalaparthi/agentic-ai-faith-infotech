# Example 074: Multiple-Axis Reduction
...
Use multiple-axis reduction when data has multiple axes such as observations, features, time, batches, images, or channels.

## Simple real-world scenario

Think of a batch of images or a table of observations and features; multiple-axis reduction helps organize or calculate across the required dimensions efficiently.
