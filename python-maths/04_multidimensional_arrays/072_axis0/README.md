...
**mean(X,axis=0) → one value per column**
...
Use axis 0 reduction when data has multiple axes such as observations, features, time, batches, images, or channels.

## Simple real-world scenario

Think of a batch of images or a table of observations and features; axis 0 reduction helps organize or calculate across the required dimensions efficiently.
