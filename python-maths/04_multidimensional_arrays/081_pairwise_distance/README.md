# Example 081: Pairwise Distances with Broadcasting
...
Use pairwise distances with broadcasting when data has multiple axes such as observations, features, time, batches, images, or channels.

## Simple real-world scenario

Think of a batch of images or a table of observations and features; pairwise distances with broadcasting helps organize or calculate across the required dimensions efficiently.
