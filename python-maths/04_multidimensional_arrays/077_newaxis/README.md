...
Use adding a new axis when data has multiple axes such as observations, features, time, batches, images, or channels.

## Simple real-world scenario

Think of a batch of images or a table of observations and features; adding a new axis helps organize or calculate across the required dimensions efficiently.
