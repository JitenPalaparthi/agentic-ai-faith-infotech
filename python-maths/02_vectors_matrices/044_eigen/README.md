# Example 044: Eigenvalues and Eigenvectors
...
Use eigenvalues and eigenvectors when studying directions that a linear transformation scales without rotating away from that direction.

## Simple real-world scenario

PCA uses eigenvectors of a covariance matrix to identify directions containing the greatest data variance.
...
Eigenvectors can be difficult to interpret directly; scaling/sign conventions may vary.
