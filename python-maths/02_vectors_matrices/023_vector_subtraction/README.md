# Example 023: Vector Subtraction
...
Use vector subtraction when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use vector subtraction while converting rows of numerical features into transformed values or geometric relationships.
