...
Use vector projection when you need the component of one vector that lies in another vector's direction.

## Simple real-world scenario

In physics, project a force vector onto the direction of motion to find the force component actually contributing along that path.
...
Projection depends on the chosen reference direction.
