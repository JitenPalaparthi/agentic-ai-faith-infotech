...
Use hadamard product when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use hadamard product while converting rows of numerical features into transformed values or geometric relationships.
