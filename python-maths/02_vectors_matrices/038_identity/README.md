...
Use identity matrix when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use identity matrix while converting rows of numerical features into transformed values or geometric relationships.
