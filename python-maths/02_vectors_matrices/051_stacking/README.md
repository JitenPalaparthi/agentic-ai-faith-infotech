...
**vertical: rows increase; horizontal: columns increase**
...
Use matrix stacking when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use matrix stacking while converting rows of numerical features into transformed values or geometric relationships.
...
Check dimensions, units, and matrix/vector shapes before interpreting the result.
