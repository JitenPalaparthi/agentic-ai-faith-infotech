# Example 043: Solving Linear Equations
...
Use solving linear equations when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use solving linear equations while converting rows of numerical features into transformed values or geometric relationships.
