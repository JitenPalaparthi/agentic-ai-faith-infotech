# Example 036: Matrix-Vector Product
...
Use matrix-vector product when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use matrix-vector product while converting rows of numerical features into transformed values or geometric relationships.
