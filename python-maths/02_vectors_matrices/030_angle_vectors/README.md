# Example 030: Angle Between Vectors
...
Use angle between vectors when representing or transforming numerical features with vector or matrix algebra.

## Simple real-world scenario

A data-science pipeline can use angle between vectors while converting rows of numerical features into transformed values or geometric relationships.
